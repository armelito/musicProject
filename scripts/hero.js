...
const SelectionSong2 = document.querySelector('.s2')
///////

/////
const song3 = document.querySelector('.song3')
const SelectionSong3 = document.querySelector('.s3')
///////
...
SelectionSong2.addEventListener('click', () =>
{
    currentSong = song2
    gameMenu.style.display = 'none'
    gameLoop()
...
SelectionSong3.addEventListener('click', () =>
{
    currentSong = song3
    gameMenu.style.display = 'none'
    gameLoop()
